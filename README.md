...
* Sales decline after noon

### 🗓️ Sales by Weekday

* Sales are consistent across weekdays
* Slight increase on Fridays

### 🏬 Store Performance

* Hell’s Kitchen generates the highest revenue
* Astoria and Lower Manhattan perform strongly
...
* Regular and Large dominate (~60%)
* Small orders are lower
...
* Optimize inventory
* Introduce combo deals

---

## 💡 Conclusion

This project demonstrates how data analysis helps improve decision-making, optimize operations, and increase revenue.
